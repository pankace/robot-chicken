...
# Function to receive UDP commands and send them over serial
def udp_to_serial(serial_port, baud_rate=9600, udp_port=5005):
...
# Start the UDP to Serial thread
# Set the serial port (e.g., '/dev/ttyUSB0') and baud rate as needed
serial_thread = Thread(target=udp_to_serial, args=('/dev/ttyUSB0', 9600))
serial_thread.start()
